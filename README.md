...
- `doc/project-context.md` gives future agents a concise overview of radicalization, the environment-versus-welfare operationalization, and the experimental logic.
